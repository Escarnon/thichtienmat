...
namespace data_access_2.Controllers
{
    public class BookManagementController : Controller
    {
        private readonly BookManagementContext _context;

        public BookManagementController(BookManagementContext context)
        {
            _context = context;
        }
        ...
        {
            var bookManagementContext = _context.Books.Include(b => b.Category).Include(b => b.Publisher);
